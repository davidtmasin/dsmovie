create table tb_comment (comments varchar(255), movie_id int8 not null, user_id int8 not null, primary key (movie_id, user_id));
create table tb_movie (id int8 generated by default as identity, comments varchar(255), count int4, image varchar(255), score float8, title varchar(255), primary key (id));
...
alter table if exists tb_comment add constraint FKi79tsew4u3uuilsvu6363c5ve foreign key (movie_id) references tb_movie;
